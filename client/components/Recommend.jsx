...
export default class Recommend extends Component {
  ...
  render() {
    let { singleListing, rejectPlace, toggleDetails, showDetails, addToBlacklist, addToWishlist, addToVisited, openModal, hideModal, map } = this.props;
    return (
      <div>
        ...
        <SubmitModal origin={map.origin} place={singleListing} onClick={() => hideModal('afterSelectModal')}/>
        </div>
      </div>
    )
  }
